import 'package:layerbit_oraculum_flutter/src/features/user_data/domain/models/user_data_model.dart';
...
class UserDataRepository {
  ...
  Future<UserDataResponse> initUserData() async {
    ...
    if (res == null || res.statusCode == 500) {
      ...
      final UserDataResponse userDataFromJson = UserDataResponse.fromJson(res.data['user']);

      await _userDataStorage.saveUserData(userDataFromJson);
